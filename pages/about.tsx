...
import { coverImg, introText, } from '../utils/data/about';
import { ReasonGrid, CategoryInfo, Video } from '../components/About';
...
const About:NextPage = () => {
  return (
      <>  
        ...
        <IntroContainer>
            <Title>{introText.title}</Title>
            <Intro>{introText.intro}</Intro>
        </IntroContainer>
        <H3Title>為何我們選用液態矽膠？</H3Title>
        <ReasonGrid/>
        <H3Title>主要產品</H3Title>
        <CategoryInfo/>
